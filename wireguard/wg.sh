...
# ==================================================
# Link Hosting Kalian
fisabiliyusri="raw.githubusercontent.com/Gashakgeneration22/Jojo-gans/main/wireguard"
...
# Tambahan
cd /usr/bin
wget -O addwg "https://raw.githubusercontent.com/Gashakgeneration22/Jojo-gans/main/wireguard/addwg.sh"
wget -O delwg "https://raw.githubusercontent.com/Gashakgeneration22/Jojo-gans/main/wireguard/delwg.sh"
wget -O renewwg "https://raw.githubusercontent.com/Gashakgeneration22/Jojo-gans/main/wireguard/renewwg.sh"
chmod +x addwg
chmod +x delwg
chmod +x renewwg
cd
